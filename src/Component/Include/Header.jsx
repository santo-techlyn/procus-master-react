                        ...
                        <div className="row align-items-center">
                            <div className="col-lg-2">
                                <div className="logo-area">
                                    <a className="dark-version" href="index.html"> <img src="assets/images/logo.png" alt="logo" /></a>
                                    <a className="light-version" href="index.html"> <img src="assets/images/logo-black.png" alt="logo" /></a>
                                </div>
                            </div>
